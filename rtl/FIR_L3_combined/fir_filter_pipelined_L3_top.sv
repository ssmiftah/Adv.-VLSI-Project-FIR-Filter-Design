// =============================================================================
// Module      : fir_filter_pipelined_L3_top
// Description : Top-level wrapper for the pipelined 3-parallel reduced-
//               complexity FIR filter.  Instantiates fir_filter_pipelined_L3
//               which contains its own coefficient ROM instances internally.
//
// Parameters  :
...
module fir_filter_pipelined_L3_top #(
    ...
    // =========================================================================
    // Pipelined L=3 FIR filter (ROM instances are internal)
    // =========================================================================
