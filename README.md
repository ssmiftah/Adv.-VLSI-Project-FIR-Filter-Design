...
## 2. Serial Architecture (`rtl/FIR_Serial/`)
...
## 3. Reduced-Complexity Parallel Processing

### 3.1 What is Parallel Processing in FIR Filters?
...
### 3.2 Naive vs Reduced Complexity
...
## 4. L=2 Parallel Architecture (`rtl/FIR_L2_reduced/`)
...
## 5. L=3 Parallel Architecture (`rtl/FIR_L3_reduced/`)
...
## 6. Combined Pipelining and Parallel Processing (`rtl/FIR_L3_combined/`)

### 6.1 What is Pipelining in this Context?
...
## 7. Systolic Array Architecture (`rtl/Systolic Filter/`)

### 7.1 Why a Systolic Array?
...
### 7.2 Why the Transposed Direct Form?
...
### 7.4 Processing Element Design (`systolic_pe.sv`)
...
### 7.5 Controller FSM (`fir_filter_systolic.sv`)
...
### 7.7 Comparison with Previous Architectures
...
### 8.1 Resource and Performance Table
